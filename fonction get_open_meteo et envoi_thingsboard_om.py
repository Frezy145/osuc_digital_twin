...
def envoi_donnees_openmeteo_thingsboard(csv_file, access_token, tb_url="https://thingsboard.cloud/api/v1"):
    """
...
if __name__ == "__main__":
    df = get_open_meteo(lat=47.833499, lon=1.943945, days_forecast=10, output_csv="OpenMeteo_forecast.csv")
    print(df.head())  # aperçu
    print(df.columns)
    
    envoi_donnees_openmeteo_thingsboard(
        csv_file="OpenMeteo_forecast.csv",
